...
If you cannot find a v1.3, any compatible Pi model will work. See the [components list](/reference/hardware/components.md) for details on the software air gap available since v0.4.5.
...
If you already know which [enclosure](/reference/hardware/enclosures.md) you plan to use, check whether it calls for the standard or compact camera board before ordering.
