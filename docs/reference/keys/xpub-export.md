...
> **New to this?** Exporting the xpub is the midpoint of the full single-sig journey. Continue with the [single-sig walkthrough](/get-started/first-wallet.md) to create the wallet in your coordinator, **verify your first receive address**, and practice recovery.
