...
4. On SeedSigner, select **Scan** from the main menu and scan the request.
5. Review what SeedSigner shows before approving:
   - the **derivation path / address** the signature will come from, and
   - the **full message text**, exactly as it will be signed.
