...
> **Warning:** If you see "Unknown QR Type," the QR code is not a valid SeedQR format. Verify you are scanning a properly formatted SeedQR and not a regular QR code. See [Error messages](/help/error-messages.md#unknown-qr-type) for details.
...
- [Export your public key (xpub)](/reference/keys/xpub-export.md)
- [Sign a transaction](/reference/keys/psbt-signing.md)
- [Explore your addresses](/reference/keys/address-explorer.md)
- [View your seed words](/reference/seeds/verification.md) to verify your backup
