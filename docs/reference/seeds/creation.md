...
8. SeedSigner prompts you to verify your backup. Select **Verify** to continue (recommended) or **Skip** to bypass.
   ...
   ![Verify Backup prompt offering Verify or Skip](../../images/SeedWordsBackupTestPromptView.png)

9. Complete the **backup verification** quiz. SeedSigner asks you to confirm specific words to prove your written backup is correct.

   ![Backup verification quiz prompting for a specific seed word](../../images/SeedBackupTestView.png)

> **Warning:** If you write even one word incorrectly, you could permanently lose access to your Bitcoin. Never skip the verification step. If you see an error, see [Error messages](/help/error-messages.md) for help.
