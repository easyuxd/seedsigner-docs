...
If your display or buttons are not behaving as expected, use the **I/O Test** found under **Settings > I/O Test** (see [Basic Settings](/reference/settings/basic.md)). The test walks you through each hardware component so you can quickly identify what is and is not working.
...
- Camera preview is blank or distorted (may need a different camera ribbon cable or rotation setting in [Advanced Settings](/reference/settings/advanced.md))
