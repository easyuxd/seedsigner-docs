...
These four steps cover the essentials. For a complete list of every option available, see the [Configuration Reference](/reference/settings/basic.md).

## Next steps

Your SeedSigner device is ready to go. Head over to [Create a new seed](/reference/seeds/creation.md) to generate your first seed phrase.

> **Tip:** If you run into hardware issues during setup, the [I/O Test](/reference/settings/basic.md#hardware-io-test) and [Common issues](/help/common-issues.md) pages can help you diagnose the problem.
