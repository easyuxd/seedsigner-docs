...
Now that your device is running, learn how to move around the interface in [Navigation basics](/getting-started/navigation.md).

> **Tip:** If the screen stays blank or the device does not boot, see [Common issues](/troubleshooting/common-issues.md#device-wont-boot).
